...
<body>
	<div class="container mt-4">
		...
		<h3>Add New Registration for ${openClass.course.name}</h3>
		...
		<div class="row">
			...
			<div class="col-4">
				...
				<form action="${save}" method="post">
					...
					<div class="mb-3">
						<input type="hidden" name="openClassId" value="${openClass.id}"/>
					</div>
					...
					<div class="mb-3"> 
						...
						<input type="text" name="phone" placeholder="Enter Phone" required="required" class="form-control" />
					</div>
